namespace HotelTransylvania.Helpers
{
    public static class StringExtentions
    {
        ...
        /// <returns>The string it has a value otherwize retures another predeffined string</returns>
        public static string StringHasValue(this string stringToBeChecked, string outputString) => !string.IsNullOrEmpty(stringToBeChecked) ? stringToBeChecked : outputString;
    }
}
